...
<head>
    ...
    <style>
        ...
        .user-stat-card { border-radius: 12px; padding: 1.5rem; box-shadow: 0 4px 12px rgba(0, 0, 0, .08);}
                        ...
                        @foreach($categories as $category)
                            <li>
                                <a class="dropdown-item{{ request('category') == $category->id ? ' active' : '' }}"
                                   href="{{ route('sejarah.index', ['category' => $category->id]) }}"
